...
def push_via_wxpusher(title, content, app_token, uid):
...
def main():
    ...
    if not (wxpusher_token and wxpusher_uid):
        print("错误: 请设置 WXPUSHER_APP_TOKEN 和 WXPUSHER_UID")
        exit(1)
    ...
    print("\n正在推送到微信...")
    push_via_wxpusher(title, content, wxpusher_token, wxpusher_uid)
